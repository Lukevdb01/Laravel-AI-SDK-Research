    ...
    private function seedLocationsInVectorDB(QdrantService $qdrant)
    {
        $location_information = [
            ...
            [
                'location' => 'Noordkade Uitjes, Verlengde Noordkade 4a, 5462 EH Veghel',
                'name' => 'Buggybaan',
                'activity_type' => 'buggybaan',
                'description' => 'Rijd in een offroad buggy over een spectaculair parcours. Geschikt voor themafeesten en teamuitjes.',
                'duration_minutes' => 45,
                'age_min' => 12,
            ],
            [
                'location' => 'Noordkade Uitjes, Verlengde Noordkade 4a, 5462 EH Veghel',
                'name' => 'Lasergamen',
                'activity_type' => 'lasergamen',
                'description' => 'Futuristische lasergame in een speelse arena. Perfect voor groepen en kinderfeestjes.',
                'duration_minutes' => 60,
                'age_min' => 8,
            ],
            [
                'location' => 'Noordkade Uitjes, Verlengde Noordkade 4a, 5462 EH Veghel',
                'name' => 'Bowlen',
                'activity_type' => 'bowlen',
                'description' => 'Klassieke bowlingplezier met vrienden of collega\'s. Inclusief schoenen en begeleiding.',
                'duration_minutes' => 90,
                'age_min' => 5,
            ],
            [
                ...
                'description' => 'Los puzzels op en ontsnap binnen 60 minuten. Uitdagend en leuk voor teambuilding.',
                'duration_minutes' => 60,
                'age_min' => 10,
            ],
            [
                'location' => 'Noordkade Uitjes, Verlengde Noordkade 4a, 5462 EH Veghel',
                'name' => 'Go-Kart Racing',
                'activity_type' => 'go-kart',
                'description' => 'Spannende go-kartbanen met professionele circuits. Geschikt voor alle leeftijden.',
                'duration_minutes' => 45,
                'age_min' => 6,
            ],
            [
                ...
                'activity_type' => 'vr',
                'description' => 'Immersieve VR-ervaringen in een state-of-the-art ruimte. Vanaf simulaties tot games.',
                'duration_minutes' => 45,
                'age_min' => 8,
            ],
        ];
